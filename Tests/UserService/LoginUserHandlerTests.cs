...
public class LoginUserHandlerTests
{
    ...
    public async Task Handle_ShouldLoginUser_WhenCredentialsAreValid()
    {
        ...
        _passwordHasher
            ...
            .ReturnsAsync(true);
        _tokenGenerator
            .Setup(gen => gen.GenerateToken(It.IsAny<string>(), It.IsAny<Guid>(), "User"))
            .ReturnsAsync("!@#");
        _configuration
        ...
        _tokenGenerator.Verify(gen => gen.GenerateToken(It.IsAny<string>(), It.IsAny<Guid>(), "User"), Times.Once);
    }
    ...
    public async Task Handle_ShouldNotLoginUser_WhenCredentialsAreInvalid()
    {
        ...
        _userRepository.Verify(repo => repo.GetByEmailAsync(It.IsAny<string>()), Times.Once);
        _passwordHasher.Verify(hasher => hasher.VerifyHash(It.IsAny<string>(), It.IsAny<string>()), Times.Once);
        _tokenGenerator.Verify(gen => gen.GenerateToken(It.IsAny<string>(), It.IsAny<Guid>(), "User"), Times.Never);
    }
